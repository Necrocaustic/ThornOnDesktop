...
class AdminCog(commands.Cog):
    ...
    async def damagecontrol(self, ctx):
    ...
    async def dmgcontrolend(self, ctx):
    ...
    @commands.command(aliases=['msgsend'])
    async def send_message(self, ctx, h: discord.TextChannel, *args):
        if ctx.message.author.guild_permissions.administrator:
            ...
            await ctx.reply('You can\'t do this. Sorry, but not really.')
